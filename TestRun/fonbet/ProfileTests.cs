...
namespace TestRun.fonbet
{
    class ProfileHistoryBet : FonbetWebProgram
    {
        ...
        public override void Run()
        {
            ...
            ClickWebElement(".//*[@class='account-calendar__row'][1]/div[1]", "Дата первого видимого дня календаря",
                "даты первого видимого дня календаря"); //подгружаю события минимум за прошедший месяц
            ...
            IWebElement betTypeGrid = GetWebElement(".//*[@class='wrap']//*[@class='operation-row _odd']/div[4]",
                "Не отображается Тип пари в гриде");
            ...
            if (!WebElementExist(".//*[@class='page-account__empty-list-text']"))
                throw new Exception(
                    "Добавился новый тип пари, кроме фрибета, суперэкспресса или линии, либо фильтры не работают");
            for (int i = 0; i < bets.Count; i++)
                bets[i].Click();
            ...
            IList<IWebElement> all =
                driver.FindElements(
                    By.XPath(
                        ".//*[@class='account-filter']/div[2]//*[@class='ui__checkboxes']/div")); //Все чекбоксы в столбце Результат
            for (var i = 1; i <= all.Count; i++)
            {
                string nameTofind =
                    string.Format(
                        ".//*[@class='account-filter']/div[2]//*[@class='ui__checkboxes']/div[{0}]//*[@class='ui__checkbox-text']/span",
                        i);
            ...
            for (var i = 1; i <= all.Count; i++)
            {
                ...
                if (!WebElementExist(".//*[@class='page-account__empty-list-text']"))
                {
                    WaitTillElementisDisplayed(driver,
                        ".//*[@class='wrap'][1]//*[@class='operation-row _odd']/div[6]/span[1]", 120);
                    IWebElement betresultGrid =
                        GetWebElement(".//*[@class='wrap'][1]//*[@class='operation-row _odd']/div[6]/span[1]",
                            "Не отображается Результат пари в гриде");
            ...
            ClickWebElement(".//*[@class='ui__checkbox-text']/*[text()='Выигрыш']", "Чекбокс Выигрыш",
                "чекбокса Выигрыш");
            WaitTillElementisDisplayed(driver, ".//*[@class='wrap'][1]//*[@class='operation-row _odd']/div[6]/span[1]",
                120);
            ClickWebElement(".//*[@class='wrap'][1]//*[@class='operation-row _odd']/div[7]",
                "Стрелка разворота события", "стрелки разворота события");
            IWebElement betValue = GetWebElement(".//*[@class='bet-details _odd']//table//*[text()='Выигрыш']",
                "Не отображается Результат пари в развернутом гриде");
            ...
            ClickWebElement(".//*[@class='account-history-bets__right']/div[1]//*[@class='account-block__head']/div",
                "Стрелка разворота календаря", "стрелки разворота календаря");
            IWebElement calendr =
                GetWebElement(".//*[@class='account-history-bets__right']/div[1]//*[@class='account-block__head']/div",
                    "Не отображается стрелка у календаря");
            ...
            ClickWebElement(".//*[@class='account-history-bets__right']/div[2]//*[@class='account-block__head']/div",
                "Стрелка разворота фильтра", "стрелки разворота фильтра");
            IWebElement filter =
                GetWebElement(".//*[@class='account-history-bets__right']/div[2]//*[@class='account-block__head']/div",
                    "Не отображается стрелка у календаря");
    ...
    class MarketingDistribution : FonbetWebProgram
    {
        ...
        public override void Run()
        {
            ...
            ClickWebElement("//*[@class='account-tabs']/a[last()]", "Вкладка Рассылки и уведомления",
                "вкладки Рассылок и уведомлений");
            ClickWebElement("//*[@class='change-password__form-inner']/div/div[1]//input",
                "Чекбокс Рассылки и уведомления", "чекбокса Рассылок и уведомлений");
            ...
            var dataPlus = String.Format("//*[@class='change-password__form-inner']/div/div[2]//input[@value={0}]",
                Convert.ToInt32(defaultValue) + 1);
            var dataMinus = String.Format("//*[@class='change-password__form-inner']/div/div[2]//input[@value={0}]",
                Convert.ToInt32(defaultValue) - 1);
            if (defaultValue != "2")
    ...
    class ProfileHistoryOperation : FonbetWebProgram
    {
        ...
        public override void Run()
        {
            ...
            {
                ClickWebElement(".//*[@class='account-menu__icon _switcher']",
                    "Стрелка сворачивания меню в личном кабинете", "стрелка сворачивания меню в личном кабинете");
                if (WebElementExist(".//*[@class='account-menu__user-name']"))
                    throw new Exception("Не работает сворачивание меню в личном кабинете");
                ClickWebElement(".//*[@class='account-menu__link _switcher']",
                    "Стрелка разворота меню в личном кабинете", "стрелка разворота меню в личном кабинете");
            }
            else
            {
                ClickWebElement(".//*[@class='account-menu__link _switcher']",
                    "Стрелка разворота меню в личном кабинете", "стрелки разворота меню в личном кабинете");
            }
            ...
            IList<IWebElement>
                all = driver.FindElements(
                    By.XPath(".//*[@class='ui__checkboxes']/div")); //Все доступные типы операций в фильтре
            for (var i = 1; i <= all.Count; i++)
            {
                string nameTofind =
                    string.Format(".//*[@class='ui__checkboxes']/div[{0}]//*[@class='ui__checkbox-text']/span", i);
            ...
            for (var i = 1; i <= all.Count; i++)
            {
                ...
                if (!WebElementExist(".//*[@class='page-account__empty-list-text']"))
                {
                    ...
                    wait.Until(
                        ExpectedConditions.ElementIsVisible(By.XPath(".//*[@class='operation-row _odd']/div[4]")));
                    IWebElement betoperationGrid = GetWebElement(".//*[@class='operation-row _odd']/div[4]",
                        "Не отображается Операции в гриде");
            ...
            ClickWebElement(".//*[@class='ui__checkbox-text']/*[text()='Заключено пари']", "Чекбокс заключено пари",
                "чекбокса заключено пари");
            WaitTillElementisDisplayed(driver, ".//*[@class='wrap'][1]//*[@class='operation-row _odd']/div[7]", 30);
            ClickWebElement(".//*[@class='wrap'][1]//*[@class='operation-row _odd']/div[7]",
                "Стрелка разворота операции", "Стрелка разворота операции");
            IWebElement betMark = GetWebElement(".//*[@class='bet-details _odd']//table//*[text()='Коэффициент']",
                "Не отображается коэффициент в развернутом гриде");
    ...
    class AuthorizationChecker : FonbetWebProgram
    {
        ...
        public override void Run()
        {
            ...
            IWebElement loginPlace =
                GetWebElement(".//*[@class='login-form__types-container']/div[2]", "Нет поля логина");
            ...
            SendKeysToWebElement(".//*[@class='login-form__form']/div[1]/input", "ya@ya.ru", "Поле логина",
                "поля логина");
            IWebElement mailPlace =
                GetWebElement(".//*[@class='login-form__types-container']/div[3]", "Нет поля логина");
            ...
            SendKeysToWebElement(".//*[@class='login-form__form']/div[1]/input", "+79991234567", "Поле логина",
                "поля логина");
            IWebElement phonePlace =
                GetWebElement(".//*[@class='login-form__types-container']/div[1]", "Нет поля логина");
    ...
    class PwdRecovery : FonbetWebProgram
    {
        ...
        public override void Run()
        {
            ...
            ClickWebElement(".//*[@href='/#!/account/restore-password']", "Кнопка Забыли пароль",
                "кнопки забыли пароль");
            ...
            SendKeysToWebElement(".//*[@class='change-password__form-inner']/div/div[2]//input", "000000005",
                "Поле номер телефона", "поля номер телефона");
            Thread.Sleep(500);
            SendKeysToWebElement(".//*[@class='change-password__form-inner']/div/div[4]//input", "1", "Поле капча",
                "поля капчи");
            ClickWebElement(".//*[@class='toolbar__item']//button", "Кнопка Отправить", "кнопки отправить");
            WaitTillElementisDisplayed(driver, ".//*[@class='toolbar__item']//button", 5);
            Thread.Sleep(500);
            SendKeysToWebElement(".//*[@class='ui__field']", "123123", "Поле Код подтверждения",
            ...
            SendKeysToWebElement(".//*[@class='ui__field']", "123456", "Поле Код подтверждения",
                "поля Код подтверждения");
            ClickWebElement(".//*[@class='toolbar__item']//button", "Кнопка Отправить", "кнопки отправить");
            WaitTillElementisDisplayed(driver, ".//*[@class='change-password__form-inner']/div/div[1]//input", 5);
            Thread.Sleep(500);
            SendKeysToWebElement(".//*[@class='change-password__form-inner']/div/div[1]//input", "1234567Q",
                "Поле Новый пароль", "поля Новый пароль");
            Thread.Sleep(500);
            SendKeysToWebElement(".//*[@class='change-password__form-inner']/div/div[2]//input", "1234567Q",
                "Поле Повторите новый пароль", "поля Повторите новый пароль");
            ClickWebElement(".//*[@class='toolbar__item']//button", "Кнопка Отправить", "кнопки отправить");
            var errorText = GetWebElement(".//*[@id='restore-password-error']", "Нет текста ошибки");
            if (!errorText.GetAttribute("data-errorcode").Equals("0") &&
                errorText.GetAttribute("data-rejectioncode").Equals("1"))
                throw new Exception("Неверный текст ошибки");
            ClickWebElement(".//*[@class='account-error__actions']//span", "Кнопка Повторить", "кнопки Повторить");
            ...
            ClickWebElement(".//*[@class='toolbar__item']//button", "Кнопка Отправить", "кнопки отправить");
            Thread.Sleep(500);
            SendKeysToWebElement(".//*[@class='change-password__form-inner']/div/div[1]//input", "!23qweQWE",
                "Поле Новый пароль", "поля Новый пароль");
            Thread.Sleep(500);
            SendKeysToWebElement(".//*[@class='change-password__form-inner']/div/div[2]//input", "!23qweQWE",
                "Поле Повторите новый пароль", "поля Повторите новый пароль");
            Thread.Sleep(500);
            ClickWebElement(".//*[@class='toolbar__item']//button", "Кнопка Отправить", "кнопки отправить");
    ...
    class EmailConfirm : FonbetWebProgram
    {
        ...
        public override void Run()
        {
            ...
            ClickOnAccount();
            ClickWebElement(".//*[@href='#!/account/profile/change-email']", "Вкладка Смена email",
                "вкладки смена email");
            ...
            ClickWebElement(".//*[@class='account-error__btn-inner']//span", "Кнопка Вернуться к профилю",
                "кнопки Вернуться к профилю");
    ...
    class RegistrationV4 : FonbetWebProgram
    {
        ...
        public override void Run()
        {
            ...
            SendKeysToWebElement(".//*[@class='reg-v4__form-column--31oQE']/div[1]//input", "Тест", "Поле Имя",
                "поля Имя");
            ClickWebElement(".//*[@id='checkbox2']", "Чекбокс Подтверждения правил", "чекбокса Подтверждения правил");
            IWebElement button = GetWebElement(".//*[@class='reg-v4__form-row--1HvrA _form-buttons--3mZsY']//button",
                "Нет кнопки отправить форму");
            ...
            SendKeysToWebElement(".//*[@class='reg-v4__form-column--31oQE']/div[5]//input", "123qwe123", "Поле Пароль",
                "поля Пароль");
            if (!button.GetAttribute("class").Contains("state_disabled"))
                throw new Exception("Возможно продолжить без email и номера телефона");
            LogStage("Заполнение контактной информации");
            SendKeysToWebElement(".//*[@class='reg-v4__form-column--31oQE']/div[3]//input", "4000100@mail.ru",
                "Поле email", "поля email");
            if (!button.GetAttribute("class").Contains("state_disabled"))
                throw new Exception("Возможно продолжить без телефона");
            Thread.Sleep(500);
            SendKeysToWebElement(".//*[@class='reg-v4__form-column--31oQE']/div[2]//input", Keys.Home + "000000001",
                "Поле Номер телефона", "поля Номер телефона");
            driver.FindElement(By.XPath(".//*[@class='reg-v4__form-column--31oQE']/div[3]//input")).SendKeys("a");
            driver.FindElement(By.XPath(".//*[@class='reg-v4__form-column--31oQE']/div[3]//input"))
            ...
            SendKeysToWebElement(".//*[@class='reg-v4__form-column--31oQE']/div[3]//input", "4000100@mail.ru",
                "Поле email", "поля email");
            Thread.Sleep(500);
            ClickWebElement(".//*[@class='reg-v4__form-row--1HvrA _form-buttons--3mZsY']//button", "Кпонка Продолжить",
                "кпонки Продолжить");
            ...
            if (!errorMessage.GetAttribute("data-rejectioncode").Equals("4") &&
                !errorMessage.GetAttribute("data-processstate").Equals("rejected") &&
                !errorMessage.GetAttribute("data-errorcode").Equals("0"))
            ...
            SendKeysToWebElement(".//*[@class='reg-v4__form-column--31oQE']/div[2]//input", "000000008",
                "Поле Номер телефона", "поля Номер телефона");
            ClickWebElement(".//*[@class='reg-v4__form-row--1HvrA _form-buttons--3mZsY']//button", "Кпонка Продолжить",
                "кпонки Продолжить");
    ...
    class VerificationCupisQiwi : FonbetWebProgram //захожу пот 13 учеткой на 5051  и смотрю чтобы была галка в админке
    {
        ...
        public override void Run()
        {
            ...
            {
                ClickWebElement(".//*[@class='verification__notice-types-wrap']//*[@class='toolbar__btn-text']",
                    "Кнопка Продолжить верификацию",
            ...
            if (!(errorMessage.GetAttribute("data-errorcode").Equals("0") &&
                  errorMessage.GetAttribute("data-processstate").Equals("rejected") &&
                  errorMessage.GetAttribute("data-rejectioncode").Equals("11")))
                throw new Exception("Неверная обработка ошибки");
            ClickWebElement(".//*[@class='account-error__actions']//span", "Кнопка Повторить", "кнопки Повторить");
            ...
            SendKeysToWebElement(".//*[@class='ui__field-wrap-inner']//input", "7", "Поле Номер телефона",
                "поля Номер телефона");
            Thread.Sleep(1000);
            ClickWebElement(".//*[@class='toolbar__item']/button", "Кнопка Подтвердить", "кнопки Подтвердить");
    ...
    class VerificationCupisBk : FonbetWebProgram //захожу пот 13 учеткой на 5051  и смотрю чтобы была галка в админке
    {
        ...
        public override void Run()
        {
            ...
            if (WebElementExist(".//*[@class='verification__notice-types-wrap']//span")) //если процесс уже существует
            {
                ...
                {
                    ClickWebElement(".//*[@class='toolbar__btn-text'][text()='Отменить']", "Кнопка Отменить",
                        "кнопки Отменить");
                    ClickWebElement("//div[contains(@class,'confirm__foot--3H8gD')]/div[2]//a", "Кнопка Да",
                        "кнопки Да");
                }
                else
                    ExecuteJavaScript("app.accountManager.cancelWaitingVerificationProcess();",
                        "Не убился процесс идентификации");
            }

            ClickWebElement(".//*[@class='verification__tab']/div[2]", "Кнопка Верификации по БК",
                "кнопки Верификации по БК");
            IWebElement inputData = GetWebElement(".//*[@class='verification__form-inner']/div/div[2]//input",
                "Нет поля номера карты фонбет");

            SendKeysToWebElement(".//*[@class='verification__form-inner']/div/div[2]//input", "0000FFFF0002",
                "Поле Номера карты фонбет", "поля Номера карты фонбет");
            Thread.Sleep(500);
            SendKeysToWebElement(".//*[@class='verification__form-inner']/div/div[3]/label[1]//input",
                Keys.Home + "2222222222", "Поле Серия и номер паспорта", "поля Серия и номер паспорта");
            Thread.Sleep(500);
            SendKeysToWebElement(".//*[@class='verification__form-inner']/div/div[3]/label[2]//input",
                Keys.Home + "11112011", "Поле Дата выдачи", "поля Дата выдачи");
            ClickWebElement(".//*[@id='rulesAgree']", "Чекбокс Соглашения с правилами",
                "чекбокс Соглашения с правилами");
            ClickWebElement(".//*[@class='toolbar__item']/button", "Кнопка Подтвердить", "кнопки Подтвердить");
            ...
            Thread.Sleep(1000);
            driver.FindElement(By.XPath(".//*[@class='verification__form-inner']/div/div[2]//input"))
                .SendKeys(Keys.Backspace);
            ClickWebElement(".//*[@class='toolbar__item']/button", "Кнопка Подтвердить", "кнопки Подтвердить");
    ...
    class RemoteVerification : FonbetWebProgram //захожу пот 13 учеткой на 5051  и смотрю чтобы была галка в админке
    {
        ...
        public override void Run()
        {
            ...
            LogStage("Проверка createProcess по тестовому сценарию");
            string[,] arrayProcess = new string[4, 4]
            {
                {"2", "0", "rejected", "11"}, {"3", "0", "rejected", "4"},
                {"4", "2", null, null}, {"5", "0", "rejected", "10"}
            };
            for (int i = 0; i < 4; i++)
            {
                driver.Navigate().GoToUrl("http://fonred5051.dvt24.com/?test=" + arrayProcess[i, 0] +
                                          "#!/account/verification/remote-verification");
                if (WebElementExist("//*[@class='verification__form-row _gap-30']/div[2]"))
                {
                    ClickWebElement("//*[@class='verification__form-row _gap-30']/div[2]", "Кнопка Отменить",
                        "кнопки Отменить");
                    ClickWebElement("//*[@class='confirm__foot--3H8gD']/div[2]/a", "Кнопка Да", "кнопки Да");
                }
                else
                    ClickWebElement("//*[@class='verification__tab']/div[1]", "Кнопка Удаленной идентификации",
                        "кнопки Удаленной идентификации");

                MakeDisplayInhert("//*[@class='verification__form-lock-container']/div[1]//input");

                SendKeysToWebElement("//*[@class='verification__form-lock-container']/div[1]//input",
                    "C:\\Users\\User\\Downloads\\саша.jpg", "Поле Главный разворот страницы",
                    "поля Главный разворот страницы");
                LogStage("Проверка на валидность аттача");
                MakeDisplayInhert("//*[@class='verification__form-lock-container']/div[2]//input");
                SendKeysToWebElement("//*[@class='verification__form-lock-container']/div[2]//input",
                    "C:\\Users\\User\\Downloads\\auto-tests.zip", "Поле Разворот с регистрацией",
                    "поля Разворот с регистрацией");
                if (!driver.FindElement(By.XPath(
                        "//*[@class='verification__form-lock-container']/div[2]//*[@class='upload-file__inner--ds5yK']/div[2]"))
                    .GetAttribute("class").Contains("error"))
                    throw new Exception("Получилось прикрепить зип фаил");
                ClickWebElement(
                    "//*[@class='verification__form-lock-container']/div[2]//*[@class='upload-file__inner--ds5yK']/i[2]",
                    "Крестик удаления файла", "крестика удаления файла");
                SendKeysToWebElement("//*[@class='verification__form-lock-container']/div[2]//input",
                    "C:\\Users\\User\\Documents\\24H soft.png", "Поле Разворот с регистрацией",
                    "поля Разворот с регистрацией");
                ...
                if (arrayProcess[i, 2] == null && arrayProcess[i, 3] == null)
                {
                    if (!(message.GetAttribute("data-errorcode").Equals(arrayProcess[i, 1])))
                        throw new Exception("Неверная обработка ошибки");
                    ClickWebElement(".//*[@class='verification__error-buttons']/div", "Кнопка Повторить",
                        "кнопки Повторить");
                }
                else
                {
                    if (!(message.GetAttribute("data-errorcode").Equals(arrayProcess[i, 1]) &&
                          message.GetAttribute("data-processstate").Equals(arrayProcess[i, 2]) &&
                          message.GetAttribute("data-rejectioncode").Equals(arrayProcess[i, 3])))
                        throw new Exception("Неверная обработка ошибки");
                    ClickWebElement(".//*[@class='verification__error-buttons']/div", "Кнопка Повторить",
                        "кнопки Повторить");
                }
            ...
            string[,] arraySms = new string[5, 4]
            {
                {"2", "0", "rejected", "14"}, {"3", "0", "rejected", "15"},
            ...
            for (int i = 0; i < 5; i++)
            {
                ...
                SendKeysToWebElement(".//*[@class='ui__field verification__sms-field']", arraySms[i, 0],
                    "Поле SMS кода", "поля SMS кода");
                Thread.Sleep(1000);
                ClickWebElement(".//*[@class='toolbar__item _reg-button']/button//span", "Кнопка Отправить",
                    "кнопки Отправить");
                if (arraySms[i, 0] == "6")
                {
                ...
                else
                {
                    WaitTillElementisDisplayed(driver, ".//*[@id='rv-error']", 10);
                    var message = GetWebElement(".//*[@id='rv-error']", "Нет модуля с ошибкой");
                    if (!(message.GetAttribute("data-errorcode").Equals(arraySms[i, 1]) &&
                          message.GetAttribute("data-processstate").Equals(arraySms[i, 2]) &&
                          message.GetAttribute("data-rejectioncode").Equals(arraySms[i, 3])))
            ...
            ClickWebElement("//*[@class='toolbar__item _reg-button']", "Кнопка Далее", "кнопки Далее");
            WaitTillElementisDisplayed(driver, ".//*[@class='ui__field verification__sms-field']", 10);
            SendKeysToWebElement(".//*[@class='ui__field verification__sms-field']", "7", "Поле SMS кода",
                "поля SMS кода");
            Thread.Sleep(1000);
            ...
            if (!(error.GetAttribute("data-errorcode").Equals("10") &&
                  error.GetAttribute("data-processstate").Equals("waitForSelectCallTime")))
            ...
            Thread.Sleep(20000);
            if (!driver.FindElement(By.XPath("//*[@class='verification__call-comment']")).Text
                .Contains("все операторы были заняты"))
                throw new Exception("Неверная обработка ошибки, когда логин=3");
            SelectSkypeLogin("44444");
            Thread.Sleep(20000);
            if (!driver.FindElement(By.XPath("//*[@class='verification__call-comment']")).Text
                .Contains("не смогли до вас дозвониться"))
            ...
            if (!(msg.GetAttribute("data-errorcode").Equals("0") &&
                  msg.GetAttribute("data-processstate").Equals("rejected") &&
                  msg.GetAttribute("data-rejectioncode").Equals("18")))
            ...
            if (!driver.FindElement(By.XPath("//*[@class='account-header__title']")).Text
                .Contains("завершения идентификации остался один шаг"))
        ...
        private void SelectSkypeLogin(string s)
        {
            ...
            Thread.Sleep(1000);
            ClickWebElement("//*[@class='verification__form-row _gap-30']/div[1]", "Кнопка Отправить",
                "кнопки Отправить");
        }
    }
    ...
    class ChangePhoneCupis : FonbetWebProgram
    {
        ...
        public override void Run()
        {
            ...
            ClickWebElement(".//*[@href='#!/account/profile/change-phone']", "Вкладка Смена номера телефона",
                "вкладки Смена номера телефона");
            LogStage("Проверка createProcess по тестовому сценарию");
    ...
    class DepositLimits : FonbetWebProgram
    {
        public static CustomProgram FabricateDepositLimits()
        {
            return new DepositLimits();
        }
        ...
        public override void Run()
        {
            void setLimit(string limitValue)
            {
               // ClickWebElement("//*[@class='account-profile__block']//a", "Кнопка Изменить", "кнопки Изменить");
                SendKeysToWebElement("//*[@class='change-password__form-inner']/div/div[1]//*[@class='ui__field-inner']//input",
                    limitValue, "Поле суточного лимита", "поля Суточного лимита");
                ClickWebElement("//*[@class='change-password__form-row']/div[1]/button", "Кнопка Установить", "кнопки Установить");
            }

            void setLimitandReject(string limitValue,string rejcode)
            {
                //ClickWebElement("//*[@class='account-profile__block']//a", "Кнопка Изменить", "кнопки Изменить");
                SendKeysToWebElement("//*[@class='change-password__form-inner']/div/div[1]//*[@class='ui__field-inner']//input",
                    limitValue, "Поле суточного лимита", "поля Суточного лимита");
                ClickWebElement("//*[@class='change-password__form-row']/div[1]/button", "Кнопка Установить", "кнопки Установить");
                var dataText = GetWebElement("//*[@id='change-phone-error']", "Нет модуля с ошибкой");
                if (!(dataText.GetAttribute("data-errorcode").Equals("0") && dataText.GetAttribute("data-processstate").Equals("rejected") && dataText.GetAttribute("data-rejectioncode").Equals(rejcode)))
                    throw new Exception("Неверная обработка ошибки");
                ClickWebElement("//*[@id='change-phone-error']//span", "кнопка Повторить", "кнопки Повторить");
            }

            base.Run();

           
            driver.Navigate().GoToUrl("http://fonred5051.dvt24.com/?test=1#!/account/responsible/deposit-limits");
            ...
            ClickWebElement("//*[@class='account-profile__block']//a", "Кнопка Изменить", "кнопки Изменить");
            setLimit("0");
            var limitText = driver.FindElement(By.XPath("//*[@class='account-error__text']")).Text;
            DateTime today = DateTime.UtcNow.Date;
            var dateToday= today.ToString("dd.MM");
            DateTime next = today.AddDays(7);
            var afterWeek = next.ToString("dd.MM");
            if (!limitText.Contains(dateToday))
                throw new Exception("Не отработала цифра 0");
            ClickWebElement("//*[@class='account-error__actions']/div[1]","Кнопка Закрыть","кнопки Закрыть");

            ClickWebElement("//*[@class='account-profile__block']//a", "Кнопка Изменить", "кнопки Изменить");
            setLimit("1");
            SendKeysToWebElement("//*[@class='ui__field']","1234","Поле Ввода смс","Поле ввода смс");
            ClickWebElement("//*[@class='change-password__form-row']/div[1]//button","Кнопка Отправить смс","кнопки Отправить смс");
            var textLimit = driver.FindElement(By.XPath("//*[@class='account-error__text']")).Text;
           
            if (!textLimit.Contains(afterWeek))
                throw new Exception("Не отработала цифра 1");
            ClickWebElement("//*[@class='account-error__actions']/div[1]", "Кнопка Закрыть", "кнопки Закрыть");
            ...
            SendKeysToWebElement("//*[@class='ui__field']", "1234", "Поле Ввода смс", "Поле ввода смс");
            ClickWebElement("//*[@class='change-password__form-row']/div[1]//button", "Кнопка Отправить смс", "кнопки Отправить смс");
            var errorText = GetWebElement("//*[@id='change-phone-error']", "Нет модуля с ошибкой");
            if (!(errorText.GetAttribute("data-errorcode").Equals("1") && errorText.GetAttribute("data-processstate").Equals("rejected") && errorText.GetAttribute("data-rejectioncode").Equals("13")))
                throw new Exception("Неверная обработка ошибки");
            ClickWebElement("//*[@id='change-phone-error']//span", "кнопка Повторить", "кнопки Повторить");

            setLimit("3");
            if (!(driver.FindElement(By.XPath("//*[@id='change-phone-error']")).GetAttribute("data-errorcode").Equals("2")))
                throw new Exception("Неверная обработка ошибки");
            ClickWebElement("//*[@id='change-phone-error']//span", "кнопка Повторить", "кнопки Повторить");
            setLimitandReject("4","12");
            setLimitandReject("5","10");
            setLimitandReject("6", "11");
            setLimitandReject("7", "4");
            setLimit("8");
            SendKeysToWebElement("//*[@class='ui__field']", "123", "Поле Ввода смс", "Поле ввода смс");
            ClickWebElement("//*[@class='change-password__form-row']/div[1]//button", "Кнопка Отправить смс", "кнопки Отправить смс");
            if (!(driver.FindElement(By.XPath("//*[@id='change-phone-error']")).GetAttribute("data-errorcode").Equals("10") && driver.FindElement(By.XPath("//*[@id='change-phone-error']")).GetAttribute("data-processstate").Equals("waitForCode")))
                throw new Exception("Неверная обработка ошибки");
            ClickWebElement("//*[@id='change-phone-error']//span", "кнопка Повторить", "кнопки Повторить");
            ...
            SendKeysToWebElement("//*[@class='ui__field']", "123", "Поле Ввода смс", "Поле ввода смс");
            ClickWebElement("//*[@class='change-password__form-row']/div[1]//button", "Кнопка Отправить смс", "кнопки Отправить смс");
            var msg = GetWebElement("//*[@id='change-phone-error']", "Нет модуля с ошибкой");
            if (!(msg.GetAttribute("data-errorcode").Equals("10") && msg.GetAttribute("data-processstate").Equals("rejected") && msg.GetAttribute("data-rejectioncode").Equals("14")))
                throw new Exception("Неверная обработка ошибки");
        }
    }
}
